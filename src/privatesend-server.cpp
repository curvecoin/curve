...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Curve related functionality
...
/*
    ...
    allow endless transaction that would bloat Curve and make it unusable. To
