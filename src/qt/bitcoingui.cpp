    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Curve Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Curve address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and curve: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Curve Core"), this);
    aboutAction->setStatusTip(tr("Show information about Curve Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Curve Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Curve addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Curve addresses"));
    ...
    openAction->setStatusTip(tr("Open a curve: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Curve Core help message to get a list with possible Curve Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Curve Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Curve network", "", count));
    } else {
...
{
    QString strTitle = tr("Curve Core"); // default title
