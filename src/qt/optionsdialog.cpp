    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("CURV-light"), QVariant("light"));
    ui->theme->addItem(QString("CURV-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("CURV-green"), QVariant("drkblue"));
    ui->theme->addItem(QString("CURV-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("CURV-traditional"), QVariant("trad"));
