    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Curve Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Curve Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  curve-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Curve in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 CURV, 0.1 CURV, 1 CURV and 10 CURV -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://curvepay.atlassian.net/wiki/display/DOC/PrivateSend\">https://curvepay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Curve Core is shutting down...") + "<br /><br />" +
