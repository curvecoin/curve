 ...
 *
 *   // network
 *   CCurveNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.curve.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CCurveNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: CurveNetwork
// //   -- signature requirements : Key1(User)
// class CCurveNetworkVariable : public CGovernanceObject
// {
// private:
