...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "CurveNetwork") type = CurveNetwork;
    if(strType == "CurveNetworkVariable") type = CurveNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == CurveNetwork) s = "CurveNetwork";
    if(type == CurveNetworkVariable) s = "CurveNetworkVariable";
