...
This mechanism has been integrated into Bitcore-Node-Curve which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/curvepay/insight-api-curve#web-socket-api](https://github.com/curvepay/insight-api-curve#web-socket-api)
* API: [https://github.com/curvepay/insight-api-curve#instantsend-transactions](https://github.com/curvepay/insight-api-curve#instantsend-transactions)
...
By default, the Curve Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Curve Core daemon:
