...
[From the curve github repo](https://github.com/curvepay/curve/blob/master/doc/masternode_conf.md)
...
## Update curve.conf on server

If you generated a new masternode private key, you will need to update the remote `curve.conf` files.

Shut down the daemon and then edit the file.

```nano .curvecore/curve.conf```

### Edit the masternodeprivkey
If you generated a new masternode private key, you will need to update the `masternodeprivkey` value in your remote `curve.conf` file.
...
and comparing with the official explorer at https://explorer.curve.org/chain/Curve
...
Search your Masternodes on https://curveninja.pl/masternodes.html
